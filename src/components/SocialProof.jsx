...
const SocialProof = () => {
    ...
    return (
        <section className="py-16 px-6 bg-[var(--gray-800)]/20 border-y border-[var(--gray-800)]">
                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center gap-8 md:gap-12">
                        ...
                        {['Cliente Demo', 'Partner 1', 'Partner 2', 'Partner 3'].map((name, i) => (
                            ...
                            >
                                <div className="text-xs text-[var(--text-secondary)] font-mono border border-[var(--gray-700)] px-4 py-2 rounded">
                                    {name}
                                </div>
                            </div>
                        ))}
