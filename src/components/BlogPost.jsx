...
const ShareButtons = ({ url, title, description }) => {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-muted text-sm mr-2">Compartir:</span>
      ...
      >
        <div className="card-featured border rounded-2xl p-12">
          ...
          <p className="text-body mb-6 max-w-2xl mx-auto">
            Compártelo con tu red para ayudar a otros profesionales tech.
          </p>
          ...
          <p className="text-muted mb-6">
            Suscríbete al newsletter para recibir más contenido sobre IA, automatización y desarrollo.
          </p>
          <a
            href="/contact"
