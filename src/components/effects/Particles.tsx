...
const defaultColors: string[] = ['#00E5FF', '#5227FF', '#B19EEF'];
...
const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error('Particles component error:', error);
      return () => {};
    }
  }, [
    particleCount,
  ...
  return <div ref={containerRef} className={`fixed inset-0 -z-10 w-screen h-screen ${className}`} />;
};
